...
class _BookListHState extends State<BookListH> {
  ...
  Widget build(BuildContext context) {
    return Consumer<FavRepo>(builder: (context, favBookRepo, child) {
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: RawMaterialButton(
                              ...
                              onPressed: () async {
                                await favBookRepo.saveAtFavorites(
                                    livro, context);
                                List<EscriboModel> a =
                                    await favBookRepo.getFavorites();
                                fav =
                                    a.any((element) => element.id == livro.id);
                                setState(() {
                                  fav;
                                });
